...
<div class="row">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Codigo barras</label>
    <div class="col-md-6">
      <input type="text" name="presentation" class="form-control" id="inputEmail1" placeholder="Codigo de barras">
    </div>
  </div>
  <div class="form-group">
